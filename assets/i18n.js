...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'home.how.intro': 'Ребёнок раскрашивает бумажную рыбку, фотографирует её телефоном — и она оживает, плавая в 3D-аквариуме на любом экране.',
      'home.how.s0d': 'На главной жми «Новый аквариум». Появятся код и пароль — сохрани их.',
      'home.how.s4d': 'Открой аквариум на телевизоре или мониторе: код или 5 цифр из «Открыть на другом экране».',
      'home.how.s1d': 'Распечатай лист с рыбкой — кнопка ниже. Один лист = одна рыбка.',
      'home.how.s2d': 'Дай ребёнку раскрасить фломастерами или карандашами. Чем ярче — тем красивее.',
      'home.how.s3d': 'Открой съёмку по ссылке на телефоне и наведи на лист — рыбка появится сама.',
      'home.how.need': 'Понадобится: принтер, фломастеры, телефон с камерой и большой экран (по желанию).',
      'home.how.print': 'Распечатать раскраски →',
      'home.how.tip': 'Ссылкой можно делиться: у кого она есть — добавляет рыбок и кормит. Пароль нужен только чтобы переименовать или удалить.',
      ...
      'menu.pred.title': 'Хищники',
      'menu.pred.on': 'включены — акулы и кальмар охотятся',
      'menu.pred.off': 'выключены — мирный аквариум',
      'menu.print.title': 'Раскраски для печати',
      'menu.print.sub': 'Виды рыбок на обычном листе A4',
    ...
    en: {
      ...
      'home.how.intro': 'A child colours a paper fish, photographs it with a phone — and it comes alive, swimming in a 3D aquarium on any screen.',
      'home.how.s0d': 'On the home page tap “New aquarium”. You’ll get a code and a password — save them.',
      'home.how.s4d': 'Open the aquarium on a TV or monitor: the code, or the 5 digits from “Open on another screen”.',
      'home.how.s1d': 'Print a fish sheet — button below. One sheet = one fish.',
      'home.how.s2d': 'Let the child colour it with markers or pencils. The brighter, the better.',
      'home.how.s3d': 'Open the capture link on a phone and point it at the sheet — the fish appears by itself.',
      'home.how.need': 'You’ll need: a printer, markers, a phone with a camera, and a big screen (optional).',
      'home.how.print': 'Print colouring sheets →',
      'home.how.tip': 'Share the link freely: anyone with it can add and feed fish. The password is only for renaming or deleting.',
      ...
      'menu.pred.title': 'Predators',
      'menu.pred.on': 'on — sharks and squid hunt',
      'menu.pred.off': 'off — peaceful tank',
      'menu.print.title': 'Colouring sheets to print',
      'menu.print.sub': 'Fish species on a plain A4 sheet',
    ...
    pl: {
      ...
      'home.how.intro': 'Dziecko koloruje papierową rybkę, robi jej zdjęcie telefonem — a ona ożywa i pływa w akwarium 3D na dowolnym ekranie.',
      'home.how.s0d': 'Na stronie głównej kliknij „Nowe akwarium”. Dostaniesz kod i hasło — zapisz je.',
      'home.how.s4d': 'Otwórz akwarium na telewizorze lub monitorze: kod albo 5 cyfr z „Otwórz na innym ekranie”.',
      'home.how.s1d': 'Wydrukuj kartę z rybką — przycisk poniżej. Jedna karta = jedna rybka.',
      'home.how.s2d': 'Daj dziecku pokolorować ją flamastrami lub kredkami. Im jaśniej, tym ładniej.',
      'home.how.s3d': 'Otwórz na telefonie link do zdjęcia i skieruj go na kartę — rybka pojawi się sama.',
      'home.how.need': 'Potrzebne będą: drukarka, flamastry, telefon z aparatem i duży ekran (opcjonalnie).',
      'home.how.print': 'Wydrukuj kolorowanki →',
      'home.how.tip': 'Linkiem można się dzielić: kto go ma, dodaje i karmi rybki. Hasło służy tylko do zmiany nazwy lub usunięcia.',
      ...
      'menu.pred.title': 'Drapieżniki',
      'menu.pred.on': 'włączone — rekiny i kałamarnica polują',
      'menu.pred.off': 'wyłączone — spokojne akwarium',
      'menu.print.title': 'Kolorowanki do druku',
      'menu.print.sub': 'Gatunki rybek na zwykłej kartce A4',
